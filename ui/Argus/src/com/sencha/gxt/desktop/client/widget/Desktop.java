...
import com.sencha.gxt.desktop.client.layout.ARGUSDesktopLayout;
//import com.sencha.gxt.desktop.client.layout.ARGUSTileDesktopLayout;
...
public class Desktop implements IsWidget {
   ...
   */
	public static final DesktopLayoutType DEFAULT_DESKTOP_LAYOUT_TYPE = DesktopLayoutType.ARGUS;
  ...
  private DesktopLayout createDesktopLayout(DesktopLayoutType desktopLayoutType) {
    ...
    switch (desktopLayoutType) {
      ...
      case TILE:
        ...
        break;
		case ARGUS:
			desktopLayout = new ARGUSDesktopLayout();
			break;
      default:
  ...
  private void showWindow(Window window) {
	...
	/*
	public void addTrayIcon(Window window) {
		taskBar.addTaskTrayIcon(window);
	}

	public void removeTrayIcon(TaskTrayIcon trayIcon) {
		taskBar.removeTrayIcon(trayIcon);
	}
	*/
}
